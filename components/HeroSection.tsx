        ...
        <div className="mt-20 text-center">
            <h3 className="text-xl text-gray-700 font-semibold mb-6">Akik már használják a rendszert:</h3>
             <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                <div className="p-2 shadow-lg rounded-lg bg-white/50 backdrop-blur-sm">
                    <img src="https://i.imgur.com/g8s2E2e.png" alt="Google vélemény 2" className="w-full h-auto rounded-md" />
                </div>
                <div className="p-2 shadow-lg rounded-lg bg-white/50 backdrop-blur-sm">
                    <img src="https://i.imgur.com/sS9AL3L.png" alt="Google vélemény 3" className="w-full h-auto rounded-md" />
                </div>
            </div>
        </div>
      </div>
